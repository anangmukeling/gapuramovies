...
public class RecyclerSearchAdapter$SearchViewHolder_ViewBinding implements Unbinder {
  private RecyclerSearchAdapter.SearchViewHolder target;

  @UiThread
  public RecyclerSearchAdapter$SearchViewHolder_ViewBinding(RecyclerSearchAdapter.SearchViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    RecyclerSearchAdapter.SearchViewHolder target = this.target;
