...
public class RecyclerPopularAdapter$ViewHolder_ViewBinding implements Unbinder {
  private RecyclerPopularAdapter.ViewHolder target;

  @UiThread
  public RecyclerPopularAdapter$ViewHolder_ViewBinding(RecyclerPopularAdapter.ViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    RecyclerPopularAdapter.ViewHolder target = this.target;
