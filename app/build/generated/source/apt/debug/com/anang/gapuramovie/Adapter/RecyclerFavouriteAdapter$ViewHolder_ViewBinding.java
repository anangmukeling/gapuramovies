...
public class RecyclerFavouriteAdapter$ViewHolder_ViewBinding implements Unbinder {
  private RecyclerFavouriteAdapter.ViewHolder target;

  @UiThread
  public RecyclerFavouriteAdapter$ViewHolder_ViewBinding(RecyclerFavouriteAdapter.ViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    RecyclerFavouriteAdapter.ViewHolder target = this.target;
