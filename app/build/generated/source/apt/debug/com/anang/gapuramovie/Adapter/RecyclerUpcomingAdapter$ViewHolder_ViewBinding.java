...
public class RecyclerUpcomingAdapter$ViewHolder_ViewBinding implements Unbinder {
  private RecyclerUpcomingAdapter.ViewHolder target;

  @UiThread
  public RecyclerUpcomingAdapter$ViewHolder_ViewBinding(RecyclerUpcomingAdapter.ViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    RecyclerUpcomingAdapter.ViewHolder target = this.target;
