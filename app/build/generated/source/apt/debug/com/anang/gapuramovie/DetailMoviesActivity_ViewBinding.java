...
public class DetailMoviesActivity_ViewBinding implements Unbinder {
  private DetailMoviesActivity target;

  @UiThread
  public DetailMoviesActivity_ViewBinding(DetailMoviesActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public DetailMoviesActivity_ViewBinding(DetailMoviesActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    DetailMoviesActivity target = this.target;
